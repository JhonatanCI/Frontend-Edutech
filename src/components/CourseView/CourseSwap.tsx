        ...
        <div>
          ...
          <div className="flex flex-row justify-between gap-24 px-0 mt-6">
            <p className="text-gray-700 text-sm w-2/5">
              Si lo deseas puedes cambiar este curso por otro que se adapte más
              a tus necesidades. Puedes hacer uso del buscador para encontrarlo.
            </p>
            <div className="w-2/3">
              <SearchBar
            ...
            {coursesMatch !== null ? (
              coursesMatch.length > 0 ? (
                ...
                <p className="text-gray-500">
                  No hay cursos disponibles para intercambio.
                </p>
              )
            ) : (
