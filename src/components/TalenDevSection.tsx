...
const TalentDevSection: React.FC = () => {
    return (
        <section className="flex flex-col justify-center pl-40 pr-40 bg-white">
            <div className="flex">
                <div >
                    ...
                    <div className="flex flex-row gap-24 mb-8">
                        <p className="text-xl text-black pt-4 w-3/5">Nos adaptamos a todos los tiempos y niveles de aventura. Conoce cómo puedes explorar nuestros mundos.</p>
                        <TalentSearchBar></TalentSearchBar>
                    </div>

                </div>

            </div>
            <div className="flex flex-row justify-center gap-6 bg-white">
