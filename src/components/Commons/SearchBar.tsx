...
const SearchBar: React.FC<SearchBarProps> = ({ search, by, handleClick }) => {
  ...
  return (
    <div className="flex mt-6">
      <input
        type="text"
        placeholder={`Buscar ${search} (e.j ${by})`}
      ...
      />
      <button onClick={handleButtonClick} className="bg-primaryBlue text-white px-4 py-2 rounded-r-sm hover:bg-primaryBlue-dark h-12">
