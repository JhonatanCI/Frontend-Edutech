...
export const ProgramsScrollSection: React.FC<ProgramsScrollSectionProps> = ({
  programs,
}) => {
    ...
    <div className="bg-white flex flex-col items-end">
      <div className="flex justify-center gap-8 items-end">
        ...
        <button onClick={handleScrollRight} disabled={isAtEnd}>
          ...
          >
            <path
              d="M36.4142 16.4142C37.1953 15.6332 37.1953 14.3668 36.4142 13.5858L23.6863 0.857864C22.9052 0.0768156 21.6389 0.0768156 20.8579 0.857864C20.0768 1.63891 20.0768 2.90524 20.8579 3.68629L32.1716 15L20.8579 26.3137C20.0768 27.0948 20.0768 28.3611 20.8579 29.1421C21.6389 29.9232 22.9052 29.9232 23.6863 29.1421L36.4142 16.4142ZM0 17H35V13H0V17Z"
      ...
      {/* Cards Scroll Nav */}
      <div
        className="flex overflow-x-auto scroll-invisible py-10 gap-8 items-center max-w-full"
        ref={containerRef}
      >
