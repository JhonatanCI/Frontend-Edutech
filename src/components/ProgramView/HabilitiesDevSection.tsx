...
import {
  getCategories,
  getMaxValue,
  getContributionForEachCategory,
...
export const HabilitiesDev: React.FC<HabilitiesDevProps> = ({
  programLearningResults,
  programCourses,
}) => {
  ...
  const data = getContributionForEachCategory(
    programCourses,
  ...
  return (
    <div className="pt-28 w-2/5">
      ...
      <span className="text-black w-3/5 mb-6">
        Para poder realizar los intercambios ten en cuenta el perfil que
        establecemos como base de nuestros programas. Desde aquí podrás empezar
        a construir tu propia maestría.
      </span>
