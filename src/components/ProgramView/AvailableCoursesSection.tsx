  ...
  return (
    <div id="courses" className="h-full w-full flex flex-col px-28 pb-14 pt-24">
      ...
      <p className="text-black w-3/5 mb-6">
        Nuestra oferta de cursos se destaca por su flexibilidad y adaptabilidad
        al perfil que quieras construir, podrás intercambiar cursos por otros
        que consideres que tienen mayor aporte a tu formación. Un intercambio{" "}
        <b>condicionado</b> significa que el curso que elijas debe desarrollar
        las mismas habilidades, y un intercambio <b>flexible</b> tiene que
        cumplir con la misma cantidad de créditos.
      </p>
