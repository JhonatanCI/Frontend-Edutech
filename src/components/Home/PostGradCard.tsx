...
const PostGradCard: React.FC<CardProps> = ({
  ...
  return (
    <div className="flex flex-col relative p-24 justify-center bg-white shadow-md rounded-lg border border-gray-200 w-[56rem] h-[39rem] transition-transform hover:scale-105">
      {/* Title */}
