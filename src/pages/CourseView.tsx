        ...
        <div className="flex-1 p-6">
          ...
          <div className="border border-gray-300 rounded-md">
            <p className="text-black">
              ...
              Accusamus, a assumenda, iure dicta quam optio nam consequuntur
              cupiditate illum nesciunt voluptas mollitia, deleniti ducimus quos
              temporibus! Tempore quis doloribus nam.
            </p>
          </div>
        </div>
          ...
          <ul className="px-12 py-8 text-xl text-black bg-white">
            <li className="py-2">
              <strong className="font-medium">
                ☑️ {currentCourse.modality}
              </strong>
            </li>
            <li className="py-2">
              <strong className="font-medium">
                ☑️ {currentCourse.credits} créditos
              </strong>
            </li>
          </ul>
        </div>
