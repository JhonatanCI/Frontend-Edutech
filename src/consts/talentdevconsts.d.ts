...
const defaultSpecializations: Program[] = [
  ...
  },
  {
    ...
    description:
      "Explora las leyes y regulaciones que gobiernan las relaciones internacionales.",
    credits: 22,
    categories: ["Categoría 1", "Categoría 2"],
  },
];
...
const defaultMasters: Program[] = [
  {
    ...
    description:
      "Profundiza en algoritmos, sistemas distribuidos y seguridad informática.",
    credits: 30,
    categories: ["Categoría 1", "Categoría 2"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Especialízate en el diagnóstico y tratamiento de trastornos psicológicos.",
    credits: 32,
    categories: ["Categoría 1", "Categoría 2"],
  },
];
...
const defaultPHD: Program[] = [
  {
    ...
    description:
      "Investigación avanzada en aprendizaje profundo y aplicaciones innovadoras.",
    credits: 50,
    categories: ["Categoría 1", "Categoría 2"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Investiga soluciones sostenibles para los desafíos ambientales globales.",
    credits: 45,
    categories: ["Categoría 1", "Categoría 2"],
  },
];
