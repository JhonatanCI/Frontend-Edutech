...
export const programCourses: ProgramCourse[] = [
  {
    ...
    description:
      "Curso de Prueba para analizar que tan bien se comporta la interfaz con datos quemados",
    credits: 2,
    ...
    fortalece: true,
    valora: true,
    learningResultsContribution: [simpleLearningResult, simpleLearningResult3],
  },
  {
    ...
    fortalece: true,
    valora: true,
    learningResultsContribution: [simpleLearningResult2, simpleLearningResult3],
  },
  {
  ...
  },
  {
    ...
    fortalece: true,
    valora: true,
    learningResultsContribution: [simpleLearningResult, simpleLearningResult2],
  },
  {
...
export const fullProgramExample: FullProgram = {
  ...
  semesters: 3,
  graduateProfile:
    "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores labore dicta sapiente iste aliquam quaerat perspiciatis dolore minima modi placeat? Cumque fuga soluta, pariatur at veniam ipsa cum quasi ipsam.",
  programType: "MAESTRIA",
  tags: "maestria, innovación, innovacion, tecnologia, tic",
  image:
    "https://th.bing.com/th/id/OIP.cv7VXyoSS47ruQQVfIgjigHaEK?rs=1&pid=ImgDetMain",
  parents: defaultPHD,
